...
- **README hero rewritten around the product's actual magic moment** (the agent's home channel messages you first) instead of catalog size. Counts corrected to reality everywhere: **95 skills = 15 hermes-* + 1 setup-* + 8 platform-* + 71 integration-***. Previously README said 95/72, CLAUDE.md said 73/68, and both installers' pickers said 68 — three different numbers for the same catalog.
