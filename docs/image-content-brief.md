...
- `# skills:  97  (15 hermes-* / 1 setup-* / 2 blueprint-* / 8 platform-* / 71 integration-*)`
...
> FIG.01 · PREMISE — one command wires 97 skills into every AI coding agent on the box.
...
**Total to feature prominently:** `97 SKILLS · 71 INTEGRATIONS · 20 TIERS`
