...
declare -A TIERS
TIERS[core]="blueprint-install blueprint-saas-founder setup-ssh-keys hermes-backup hermes-cron hermes-deploy hermes-fix hermes-home hermes-install hermes-integrate hermes-mcp-add hermes-memory hermes-model hermes-restart hermes-skills hermes-soul hermes-status hermes-update"
